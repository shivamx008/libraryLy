...
<head>
    ...
    <meta name="description" content="Welcome to the most extraordinary Library">
    ...
    <section id="library-info" class="bg-dark">
        <div class="container ">
            <div class="box1 bg-light cs1">
                ...
                <h3><a href="books.php" class="btn btn-light">Books</a></h3>

            </div>
            <div class="box1 bg-light cs1">
                <i class="fas fa-user-alt fa-3x"></i>
                <h3><a href="profile.php" class="btn btn-light">User</a></h3>

            </div>
            <div class="box1 bg-light cs2">
                <i class="fas fa-envelope fa-3x"></i>
                <h3><a href="issue_info.php" class="btn btn-light"> Reports</a><h3>

            </div>
            <div class="box1 bg-light cs2">
                <i class="fas fa-receipt fa-3x"></i>
                <h3><a href="expired.php" class="btn btn-light">Fine</a><h3>
