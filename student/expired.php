...
<div id="main">
  ...
  <div class="container">
    <h2 style="text-align: center;">Information of Expired/Returned Books</h2><br>
    <?php
      if(isset($_SESSION['login_user']))
      {
        ?>
      ...
      <div style="float: right;padding-top: 10px;">
        ...
        <?php
        $var=0;
          $result=mysqli_query($db,"SELECT * FROM `fine` where username='$_SESSION[login_user]' and status='unpaid' ;");
...
<br><br><br><br>
        ...
        {
        $sql="SELECT student.username,roll,books.bid,name,authors,edition,approve,issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve !='' and issue_book.approve !='pending'  and issue_book.username ='$_SESSION[login_user]' ORDER BY `issue_book`.`return` DESC";
        $res=mysqli_query($db,$sql);
        }
