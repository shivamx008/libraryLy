...
<div id="main">
  ...
  <div id="container">
      <div class="form-wrap">
    <h2 style="color:black; font-family: inherit; text-align: center"><b>Delete Books</b></h2>

    <form class="book" action="delete.php" method="post">
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        ...
        mysqli_query($db,"DELETE FROM issue_book WHERE bid= '$_POST[bid]' and approve = 'yes' ;");
        ?>
