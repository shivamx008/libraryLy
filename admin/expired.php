...
<!--_________________sidenav_______________-->
  ...
  <div class="h"> <a href="request.php">Issue Request</a></div>
    ...
    <?php
      ...
      <form method="post" action="">
          ...
          <form method="post" action="" name="form1">
            <label for="username">Enter the student's username returning the book</label>
      ...
      while($row=mysqli_fetch_assoc($res))
      {
        ...
        if($diff>=0)
        {
          ...
          mysqli_query($db,"UPDATE fine SET status='paid' where username='$_POST[username]' and bid='$_POST[bid]' ");
